...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/padelpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14882&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/padelpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `padelpy` can be installed with:

```
conda install padelpy
```

It is possible to list all of the versions of `padelpy` available on your platform with:
